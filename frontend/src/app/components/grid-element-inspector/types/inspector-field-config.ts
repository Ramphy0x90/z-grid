...
const LINE_FIELDS: readonly FieldDescriptor[] = [
	...
	{ key: 'r0Pu', label: 'R0 (p.u.)', inputType: 'number', step: '0.000001' },
	{ key: 'x0Pu', label: 'X0 (p.u.)', inputType: 'number', step: '0.000001' },
	{ key: 'b0Pu', label: 'B0 (p.u.)', inputType: 'number', step: '0.000001' },
...
const TRANSFORMER_FIELDS: readonly FieldDescriptor[] = [
	...
	{ key: 'r0Pu', label: 'R0 (p.u.)', inputType: 'number', step: '0.000001' },
	{ key: 'x0Pu', label: 'X0 (p.u.)', inputType: 'number', step: '0.000001' },
	{ key: 'vectorGroup', label: 'Vector Group', inputType: 'text' },
	{ key: 'hvNeutralGrounding', label: 'HV Neutral Grounding', inputType: 'text' },
	{ key: 'lvNeutralGrounding', label: 'LV Neutral Grounding', inputType: 'text' },
	{
		key: 'hvNeutralResistancePu',
		label: 'HV Neutral R (p.u.)',
		inputType: 'number',
		step: '0.000001',
	},
	{
		key: 'hvNeutralReactancePu',
		label: 'HV Neutral X (p.u.)',
		inputType: 'number',
		step: '0.000001',
	},
	{
		key: 'lvNeutralResistancePu',
		label: 'LV Neutral R (p.u.)',
		inputType: 'number',
		step: '0.000001',
	},
	{
		key: 'lvNeutralReactancePu',
		label: 'LV Neutral X (p.u.)',
		inputType: 'number',
		step: '0.000001',
	},
	{ key: 'fromSwitchClosed', label: 'From Switch Closed', inputType: 'boolean' },
...
const GENERATOR_FIELDS: readonly FieldDescriptor[] = [
	...
	{ key: 'x2Pu', label: 'X2 (p.u.)', inputType: 'number', step: '0.0001' },
	{ key: 'x0Pu', label: 'X0 (p.u.)', inputType: 'number', step: '0.0001' },
	{ key: 'neutralGrounded', label: 'Neutral Grounded', inputType: 'boolean' },
	{
		key: 'neutralResistancePu',
		label: 'Neutral R (p.u.)',
		inputType: 'number',
		step: '0.0001',
	},
	{
		key: 'neutralReactancePu',
		label: 'Neutral X (p.u.)',
		inputType: 'number',
		step: '0.0001',
	},
