...
import com.r16a.zeus.features.engine.remote.RemotePythonPowerQualityEngineAdapter;
...
public class PowerQualitySimulationExecutor implements SimulationExecutor {
    ...
    public String defaultEngineKey() {
        return RemotePythonPowerQualityEngineAdapter.ENGINE_KEY;
    }
    ...
    public SimulationExecutionResult execute(SimulationExecutionRequest request) {
        ...
        try {
            EngineFacade engineFacade = engineFacadeRouter.resolve(SimulationType.POWER_QUALITY, engineKey);
