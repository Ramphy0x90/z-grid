...
@Component
public class RemotePythonHostingCapacityEngineAdapter implements EngineFacade {
    public static final String ENGINE_KEY = "remote-python-hosting-capacity-v1";
    ...
    public RemotePythonHostingCapacityEngineAdapter(
