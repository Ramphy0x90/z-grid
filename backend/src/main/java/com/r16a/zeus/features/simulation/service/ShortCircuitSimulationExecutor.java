...
import com.r16a.zeus.features.engine.remote.RemotePythonShortCircuitEngineAdapter;
...
public class ShortCircuitSimulationExecutor implements SimulationExecutor {
    ...
    public String defaultEngineKey() {
        return RemotePythonShortCircuitEngineAdapter.ENGINE_KEY;
    }
    ...
    public SimulationExecutionResult execute(SimulationExecutionRequest request) {
        ...
        try {
            EngineFacade engineFacade = engineFacadeRouter.resolve(SimulationType.SHORT_CIRCUIT, engineKey);
