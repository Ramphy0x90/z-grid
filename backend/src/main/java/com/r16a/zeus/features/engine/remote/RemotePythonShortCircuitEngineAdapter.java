...
@Component
public class RemotePythonShortCircuitEngineAdapter implements EngineFacade {
    public static final String ENGINE_KEY = "remote-python-short-circuit-v1";
    ...
    public RemotePythonShortCircuitEngineAdapter(
