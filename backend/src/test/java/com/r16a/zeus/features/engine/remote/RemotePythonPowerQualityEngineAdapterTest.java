...
class RemotePythonPowerQualityEngineAdapterTest {
    ...
    void executeReturnsSummaryAndDataFor200Response() throws Exception {
        ...
        RemotePythonPowerQualityEngineAdapter adapter = new RemotePythonPowerQualityEngineAdapter(
                new ObjectMapper(),
                baseUrl,
    ...
    void executeMapsValidationStatusToValidationFailureCode() throws Exception {
        ...
        server.createContext("/api/v1/engine/execute", (exchange) -> {
            String payload = """
                    {"errorCode":"VALIDATION","message":"Invalid power-quality input"}
                    """;
